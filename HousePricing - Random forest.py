...
rand_for_regressor =  RandomForestRegressor(random_state=0)
grid_search = GridSearchCV(estimator = rand_for_regressor, 
...
# Predicition
test_predict = rand_for_regressor.predict(test_X)
